...
export const ESPECIES_INICIAIS: Especie[] = [
  ...
  },
  {
    ...
    categoria: 'vaso',
    // ficheiro nativo so tem 809x1214 -- abaixo do balde de 1280px do Wikimedia,
    // por isso serve-se a imagem original em vez de um thumb (fica mais nitida)
    imagemUrl: 'https://upload.wikimedia.org/wikipedia/commons/8/85/Echeveria_elegans_-_1.jpg',
    imagemJovemUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Rosa_de_alabastro_%28Echeveria_elegans%29%2C_jard%C3%ADn_del_molino%2C_Sierra_de_San_Felipe%2C_Set%C3%BAbal%2C_Portugal%2C_2012-05-11%2C_DD_01.JPG/1280px-Rosa_de_alabastro_%28Echeveria_elegans%29%2C_jard%C3%ADn_del_molino%2C_Sierra_de_San_Felipe%2C_Set%C3%BAbal%2C_Portugal%2C_2012-05-11%2C_DD_01.JPG',
  ...
  },
  {
    ...
    nome: 'Calêndula',
    categoria: 'flor',
    imagemUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Calendula_January_2008-1_filtered.jpg/1280px-Calendula_January_2008-1_filtered.jpg',
    // ficheiro nativo so tem 1000x665 -- abaixo do balde de 1280px, serve-se a imagem original
    imagemJovemUrl: 'https://upload.wikimedia.org/wikipedia/commons/3/30/Calendula_officinalis_0zz.jpg',
    luzIdeal: 'sol_pleno',
    regarCadaHoras: 48,
    humidadeIdealMin: 45,
    humidadeIdealMax: 55,
  ...
  },
  {
    ...
    nome: 'Alecrim',
    categoria: 'arbusto',
    imagemUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Rosemary_in_bloom.JPG/1280px-Rosemary_in_bloom.JPG',
  ...
  },
  {
    ...
    categoria: 'vaso',
    imagemUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Mammillaria_tayloriorum.jpg/1280px-Mammillaria_tayloriorum.jpg',
    imagemJovemUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Thimble_cactus.jpg/1280px-Thimble_cactus.jpg',
    luzIdeal: 'sol_pleno',
    regarCadaHoras: 168,
    humidadeIdealMin: 10,
    humidadeIdealMax: 20,
  ...
  },
  {
    ...
    nome: 'Girassol',
    categoria: 'flor',
    imagemUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/Sunflower_sky_backdrop.jpg/1280px-Sunflower_sky_backdrop.jpg',
    imagemJovemUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/ISS-38_Young_sunflower_plant.jpg/1280px-ISS-38_Young_sunflower_plant.jpg',
    luzIdeal: 'sol_pleno',
    regarCadaHoras: 36,
    humidadeIdealMin: 50,
    humidadeIdealMax: 60,
